...
public class PluginConfiguration {
    ...
    public static final String DEVELOPER_CREDITS = "Gucci Fox";

    // The base prefix to all commands within the plugin
    public static final String COMMAND_BASE = "blockmaster";
    ...
    public static String getVersion() {
        return BlockMaster.getInstance().getDescription().getVersion();
    }
    ...
    public static String getName() {
        return BlockMaster.getInstance().getDescription().getName();
    }
    ...
    public static String getDescription() {
        return BlockMaster.getInstance().getDescription().getDescription();
    }
    ...
    public static String getURL() {
        return BlockMaster.getInstance().getDescription().getWebsite();
    }
}
